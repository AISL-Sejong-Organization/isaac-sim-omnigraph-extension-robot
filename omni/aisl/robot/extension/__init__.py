...
class OmniAislRobotExtensionExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.aisl.robot.extension] OmniAislRobotExtensionExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.aisl.robot.extension] OmniAislRobotExtensionExtension shutdown", flush=True)
